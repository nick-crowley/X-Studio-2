...
namespace Logic
{
   namespace Scripts
   {
      namespace Compiler
      {
         ...
         CommandTree::GeneratingVisitor::GeneratingVisitor(ScriptFile& s, ErrorArray& e) : Errors(e), Script(s)
         {
         }

         /// <summary>Nothing</summary>
         CommandTree::GeneratingVisitor::~GeneratingVisitor()
         {
         }
         ...
         void  CommandTree::GeneratingVisitor::VisitNode(CommandTree* n) 
         {
            try
            {
