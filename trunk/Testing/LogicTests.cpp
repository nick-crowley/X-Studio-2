...
#include "../Logic/LegacySyntaxFileReader.h"
...
namespace Testing
{
   ...
   void LogicTests::BatchTest_ScriptCompiler()
   {
      ...
      vector<wstring> SkipList = 
      {
         ...
         //L"lib.cm.getcomplexes.xml",                  // X3AP: Extra argument in call to external script
         //L"lib.cm.stationsofcomplex.xml"              // X3AP: Extra argument in call to external script
      };
