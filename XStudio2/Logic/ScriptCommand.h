...
namespace Logic
{
   namespace Scripts
   {
      ...
      private:
         ScriptCommand();
      public:
         ScriptCommand(const wstring& text, CommandSyntaxRef syntax, ParameterArray& params);
         ScriptCommand(const wstring& text, CommandSyntaxRef syntax, ParameterArray& infix, ParameterArray& postfix);
